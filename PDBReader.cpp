   ...
   const bool   useModels)
{
   for (int i=0; i<NB_ELEMENTS;++i)
   {
      ...
      cudaKernel.setMaterial(
         i,
         static_cast<float>(colormap[i].R)/255.f,
         static_cast<float>(colormap[i].G)/255.f,
         static_cast<float>(colormap[i].B)/255.f,
         0.f,0.f,0.f,false,false,0,0.f,0.f,
         TEXTURE_NONE,TEXTURE_NONE,TEXTURE_NONE,TEXTURE_NONE,TEXTURE_NONE,TEXTURE_NONE,TEXTURE_NONE,
         1.f,100.f,0.f,
         /*(i%3==0) ? 0.5f : 0.f,*/ 0.f,
