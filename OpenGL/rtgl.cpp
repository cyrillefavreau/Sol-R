   ...
   long B = 0;
	for( int i(start); i<end; ++i ) 
	{
      ...
      Vertex innerIllumination = { 0.f, 40000.f, gSceneInfo.viewDistance.x };
		...
		float r,g,b,noise;
      float opacity=gSceneInfo.viewDistance.x;
      ...
      int material = update ? i : RayTracer::gKernel->addMaterial();
		RayTracer::gKernel->setMaterial(
         ...
         textureId, TEXTURE_NONE, TEXTURE_NONE, TEXTURE_NONE, TEXTURE_NONE, TEXTURE_NONE, TEXTURE_NONE,
   ...
   */
   {
      ...
      RayTracer::gKernel->setMaterial( m, 
         red, green, blue,
         0.f, 0.f, 1.2f, 
         false, 0.f, 0, alpha, gSceneInfo.viewDistance.x, 
         MATERIAL_NONE, MATERIAL_NONE, MATERIAL_NONE, MATERIAL_NONE, TEXTURE_NONE, TEXTURE_NONE, TEXTURE_NONE,
         1.f, 200.f, 1000.f, 
         0.f, 0.f, 0.f, false);
