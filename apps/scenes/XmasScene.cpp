...
________________________________________________________________________________
*/
void XmasScene::createTree(int iteration, int boxId, int maxIterations, Vertex center, int material, float interval,
                           float radius)
{
    if (iteration > 0)
    {
...
#if 1
            Vertex angles = {((i == 0) ? 0.5f : 2.f) * (rand() % 100 / 100.f - 0.5f),
