...
________________________________________________________________________________
*/
void FractalScene::createFractals(int iteration, int modelId, int mode, int maxIterations, FLOAT4 center, int material,
                                  float interval, float radius)
{
    FLOAT4 positions[NB_MODELS][NB_ELEMENTS] = {{{-1.f, -1.f, -1.f, 0.f},
                                                 {1.f, -1.f, -1.f, 0.f},
                                                 {0.f, -1.f, 1.f, 0.f},
                                                 {0.f, 1.f, 0.f, 0.f},
                                                 {0.f, 0.f, -1.f, 0.f},
