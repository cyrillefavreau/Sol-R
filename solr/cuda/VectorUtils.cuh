...
________________________________________________________________________________
*/
__device__ __INLINE__ void vectorReflection(Vertex &r, const Vertex &i,
                                            const Vertex &n) {
  r = i - 2.f * dot(i, n) * n;
}
...
________________________________________________________________________________
*/
__device__ __INLINE__ void vectorRefraction(Vertex &refracted,
...
vectorRotation(Vertex &v, const Vertex &rotationCenter, const Vertex &angles) {
